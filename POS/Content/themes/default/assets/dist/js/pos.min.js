...
function loadItems() {
    ...
    if (get('spositems')) {
        ...
        $.each(spositems, function () {
            ...
            tr_service_html = '<td></td><td colspan="2"><select class="form-control select2" style="border-radius:7px"><option diabled slelcted>Assign To</option><option>The Labib</option></select></td><td><input type="text" class="form-control datepicker" placeholder="From"></td><td><input type="text" class="form-control datepicker" placeholder="To"></td>';
            tr_html =
            ...
            tr_html +=
                ...
                '</span></td><td class="text-center">0</td>';
            tr_html +=
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    bootbox.confirm("Do you want to print order?", function (result) {
                        if (result == true) {
                            window.open("" + base_url + "/POS/PrintOrder", '_blank');
                        }
                        if (result == false) {
                            window.location.href = base_url + "/POS/Index";
                        }
