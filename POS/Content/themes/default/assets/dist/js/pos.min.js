...
function loadItems() {
    ...
    if (get('spositems')) {
        ...
        $.each(spositems, function () {
            ...
            if (KeyId == item_id) {
                Item_Tax = item_Quantity * net_price * (item.Tax / 100);
                }
            ...
            //    Net_unit_price: Unit_price - pr_Tax_val,
            //    Discount: 0,
            //    comment: '',
            ...
            if (KeyId == item_id) {
                ...
                spositems[KeyId].Item_discount += Item_discount;
        ...
        var  order_Tax = 0;
            ...
            if (Settings.remote_printing != 1) {
                ...
                //    "Unit_price": $("#total").html(),
                //    "Net_unit_price": 1,
                //    "Discount": $("#ds_con").html(),
                //    "Item_discount": 1,
                //    "Tax": $("#ts_con").html(),
                //    "Item_Tax": 5,
                //    "Subtotal": $(".sSubtotal").html(),
                //    "Real_unit_price": $(".Real_unit_price").html(),
                //    "Cost": $("#total-payable").html(),
                //    "Product_code": $(".product-code").html(),
                //    "Product_name": $(".product-name").html(),
                //    "Comment": $("#hold_ref").val()
                //};

                //var filtered = sale_items.filter(function (value, index, arr) {
...
$(document).ready(function () {
    ...
    $(document).on('click', '.product', function (e) {
        ...
        var data = {
            ...
            Quantity: 1,
            Product_code: $(this).data("itembarcode"),
        ...
        //$.ajax({
        //    type: 'get',
        //    url: base_url+ '/POS/GetItemsById?Id=' + code,
        //    dataType: 'json',
    ...
    $('#payment').click(function () {
        ...
        if (count <= 1) {
            bootx.alert("please_add_product");
            return false;
        } else {
            if (sid) {
                suspend = $('<span></span>');
    ...
    $('#submit-sale').click(function () {
        debugger
        var sale_items = [];
        //$(spositems).each(function (key, value) {
        //    debugger
        //var result_items = {
        ...
        //};
        //sale_items.push(result_items)
        //});
        //for (var i = 0; i < spositems; i++) {
        //    var result_items = {
        //        "Product_id": spositems[i].Product_id,
        //        "Quantity": spositems[i].Quantity,
        //        "Unit_price": spositems[i].Unit_price,
        //        "Net_unit_price": spositems[i].Net_unit_price,
        //        "Discount": spositems[i].Discount,
        //        "Item_discount": spositems[i].Item_discount,
        //        "Tax": spositems[i].Tax,
        //        "Item_tax": spositems[i].Item_tax,
        //        "Subtotal": spositems[i].Subtotal,
        //        "Real_unit_price": spositems[i].Real_unit_price,
        //        "Cost": spositems[i].Cost,
        //        "Product_code": spositems[i].Product_code,
        //        "Product_name": spositems[i].Product_name,
        //        "Comment": spositems[i].Comment
        //    };
        //    sale_items.push(result_items)
        //}
        var sale_items = Object.keys(spositems).map((key) => spositems[key]);
        var result = {
            "Customer_name": "The Labib",
            "Customer_id": 1,
            "Store_id": 1,
