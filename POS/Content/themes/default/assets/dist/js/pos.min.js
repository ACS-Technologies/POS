            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.Data.SaleItems.length; i++) {
                    ...
                    obj = {
                        ...
                        Product_code: data.Data.SaleItems[i].Product_code == "0" ? "###" : data.Data.SaleItems[i].Product_code,
...
$(document).ready(function () {
    ...
    $(document).on('click', '.product', function (e) {
        ...
        var data = {
            ...
            Quantity: 1,
            Product_code: $(this).data("itembarcode") == "0" ? "###" : $(this).data("itembarcode"),
    ...
    $(document).on('click', '.category', function () {
        ...
        if (cat_id != cid) {
            ...
            $.ajax({
                ...
                data: { category_id: cat_id, tcp: 1 }R,
                dataType: 'json',
                success: function (data) {
                    p_page = 'n';
    ...
    $('#submit-sale').click(function () {
        ...
        for (var i = 0; i < sale_items.length; i++) {
            sale_items[i].FromDate = new Date(sale_items[i].FromDate + ' ' + sale_items[i].FromTime);
            sale_items[i].ToDate = new Date(sale_items[i].ToDate + ' ' + sale_items[i].ToTime);
