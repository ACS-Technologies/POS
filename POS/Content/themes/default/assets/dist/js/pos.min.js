...
function loadItems() {
    ...
    if (get('spositems')) {
        ...
        $.each(spositems, function () {
            ...
            tr_service_html = '<td></td><td colspan="2"><div class="form-group"><label>Assign To</label><div class="input-group" style="position: relative"><input type="text" class="from-control" /><button class="btn btn-primary bank-btn" type="button" data-toggle="modal" data-target="#AssignUserModal"><i class="fa fa-search"></i></button></div></div></td><td><input type="text" class="form-control datepicker" placeholder="From"></td><td><input type="text" class="form-control datepicker" placeholder="To"></td>';
            tr_html =
